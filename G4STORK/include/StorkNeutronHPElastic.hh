...
#ifndef StorkNeutronHPElastic_h
#define StorkNeutronHPElastic_h 1
...
class StorkNeutronHPElastic : public G4HadronicInteraction
{
  public:

  StorkNeutronHPElastic(G4double finalStateTemp);

  ~StorkNeutronHPElastic();
  ...
  std::vector<StorkNeutronHPChannel*> theElastic;
  G4String dirName;
  G4int numEle;
