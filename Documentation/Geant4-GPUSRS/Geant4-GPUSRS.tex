...
G4STORK is only able to be run on Fedora and OSx. Therefore the project is constrained to only being able to run on Fedora and OSx. Thus the completed project is expected to run on Fedora and OSx. 
