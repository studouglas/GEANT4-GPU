...
{ReqType_Performance}
{PUC_SimulatingParticles}
{Decrease the time it takes to run a particle simulation on the GPU while maintaining the same output.}
...
NA -- The product will be used by single researchers, and is run locally on their machines. This project does not encompass the giving the functionality for distributing GEANT4-GPU to multiple GPU's. 
