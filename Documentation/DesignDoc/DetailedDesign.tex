...
Added some more sections, renamed current ones & Stuart & 2016-01-08\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\caption{NeutronHPDataPoint -- interface syntax}\label{Table_NeutronHPDataPointInterface}
...
\caption{G4NeutronHPVector -- interface syntax}\label{Table_NeutronHPVectorInterface}\\
\toprule
\bf Routine Name & \bf Input & \bf Output & \bf Exceptions \\\midrule
\arrayrulecolor{lightgray}
...
Merge & G4InterpolationScheme, \\\hline
&  G4double, \\\hline
& G4NeutronHPVector *, \\\hline
& G4NeutronHPVector * & & \\\hline
...
\subsubsection{Interface Syntax}% ================ Victor
\begin{table}[h]
\caption{CMake Files -- interface syntax}\label{Table_CMakeInterface}
