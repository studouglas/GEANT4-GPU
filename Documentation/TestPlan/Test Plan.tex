...
\begin{tabular}{ | c | c | p{3cm} | p{5cm}| p{4.5cm} |}\toprule
...
Particles = 20 }
& Same output as non-GPU G4STORK 
& SCWRDopplerInput.txt -- Many runs\\
...
Particles = 20} 
& Same output as non-GPU G4STORK 
& SCWRDopplerInput.txt -- Short simulation\\
...
Particles = 20 }
& Same output as non-GPU G4STORK 
& SCWRDopplerInput.txt -- Long simulation\\
...
Particles = 2 }
& Same output as non-GPU G4STORK 
& SCWRDopplerInput.txt -- Few Particles\\
