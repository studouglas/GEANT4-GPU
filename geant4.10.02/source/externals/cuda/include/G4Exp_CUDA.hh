...
inline float G4Expf(float initial_x)
{
    ...
    float z = G4ExpConsts::fpfloor( G4ExpConsts::LOG2EF * x +0.5f ); /* std::floor() truncates toward -infinity. */
    ...
    if (initial_x > G4ExpConsts::MAXLOGF) z=std::numeric_limits<float>::infinity();
